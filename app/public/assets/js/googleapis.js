...
(function () {
    ...
    google.maps.Load = function (apiLoad) {
        ...
        apiLoad([0.009999999776482582, [null, [
                    ["https://khms0.googleapis.com/kh?v=798\u0026hl=tr-TR\u0026", "https://khms1.googleapis.com/kh?v=798\u0026hl=tr-TR\u0026"], null, null, null, 1, "798", ["https://khms0.google.com/kh?v=798\u0026hl=tr-TR\u0026", "https://khms1.google.com/kh?v=798\u0026hl=tr-TR\u0026"]
                ], null, null, null, null, [
                    ["https://cbks0.googleapis.com/cbk?", "https://cbks1.googleapis.com/cbk?"]
                ],
                [
                    ["https://khms0.googleapis.com/kh?v=113\u0026hl=tr-TR\u0026", "https://khms1.googleapis.com/kh?v=113\u0026hl=tr-TR\u0026"], null, null, null, null, "113", ["https://khms0.google.com/kh?v=113\u0026hl=tr-TR\u0026", "https://khms1.google.com/kh?v=113\u0026hl=tr-TR\u0026"]
                ],
                [
                    ["https://mts0.googleapis.com/mapslt?hl=tr-TR\u0026", "https://mts1.googleapis.com/mapslt?hl=tr-TR\u0026"]
                ], null, null, null, [
                    ["https://mts0.googleapis.com/mapslt?hl=tr-TR\u0026", "https://mts1.googleapis.com/mapslt?hl=tr-TR\u0026"]
                ]
            ],
            ["tr-TR", "US", null, 0, null, null, "https://maps.gstatic.com/mapfiles/", "https://csi.gstatic.com", "https://maps.googleapis.com", "https://maps.googleapis.com", null, "https://maps.google.com", "https://gg.google.com", "https://maps.gstatic.com/maps-api-v3/api/images/", "https://www.google.com/maps", 0, "https://www.google.com"],
            ["https://maps.googleapis.com/maps-api-v3/api/js/32/12/intl/tr_ALL", "3.32.12"],
            [1816573501], 1, null, null, null, null, null, "", null, null, 1, "https://khms.googleapis.com/mz?v=798\u0026", "AIzaSyCu60gKZgBm8f0Rwhcv7lia2kHRR9_vR3o", "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "https://mts.googleapis.com/maps/vt/icon", [
                ["https://maps.googleapis.com/maps/vt"],
                ["https://maps.googleapis.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 419000000, 419
...
// inlined
(function (_) {
    var ta, xa, za, Ba, Ca, Da, Pa, Qa, bb, gb, hb, jb, ob, nb, pb, qb, Hb, Jb, Nb, Ub, Xb, Yb, hc, lc, pc, Cc, Dc, Ec, Fc, Hc, Ic, Lc, Oc, Kc, Pc, Sc, Yc, id, kd, md, pd, sd, qd, Ad, Ed, Gd, Jd, Kd, Nd, Pd, Rd, Md, Od, Xd, Yd, Zd, ne, oe, pe, re, se, ve, we, Ae, Be, Ce, De, Ge, Ie, Je, Te, Ue, Ve, We, Ye, Ze, lf, mf, nf, uf, vf, wf, xf, yf, Ef, Ff, Mf, Of, Pf, Qf, Wf, Uf, Zf, $f, bg, eg, gg, fg, ig, mg, og, tg, ug, xg, yg, zg, Ag, Bg, Dg, wa, va, Ma, Na;
    _.aa = "ERROR";
    ...
    _.ec = function (a, b) {
        return new _.Zb((a.m22 * b.X - a.m12 * b.$) / a.f, (-a.m21 * b.X + a.m11 * b.$) / a.f)
    };
    _.fc = function (a) {
    ...
    lf = function (a, b) {
        ...
        this.b = a;
        this.m = !1;
        this.__gm.ac = b && b.ac || new _.ad;
        this.set("standAlone", !0);
        this.setPov(new _.fd(0, 0, 1));
    ...
    Ca("Promise", function (a) {
        ...
        b.prototype.I = function (a) {
            ...
            else if (a instanceof b) this.Y(a);
            else {
                a: switch (typeof a) {
                    case "object":
                        var c = null != a;
    ...
    _.od.prototype.forEach = function (a) {
        for (var b = 1 + this.Qb, c = 0, d = {
            ...
            f ? (b += f[1].length, d.Md = (0, window.parseInt)(f, 10)) : d.Md++;
            f = this.b[b++];
            var g = f.toLowerCase();
            d.Ud = g != f;
    ...
    Ad.prototype.set = function (a, b) {
        if (null != b && !(b && _.F(b.maxZoom) && b.tileSize && b.tileSize.width && b.tileSize.height && b.getTile && b.getTile.apply)) throw Error("google.maps.MapType'\u0131 uygularken beklenen de\u011fer");
    ...
    */
    ...
    _.m.url_changed = Ge.prototype.ce;
    _.m.driveFileId_changed = Ge.prototype.ce;
    _.m.map_changed = Ge.prototype.ce;
    _.m.zIndex_changed = Ge.prototype.ce;
    _.Xc(Ge.prototype, {
        map: _.Fh,
    ...
    _.m.changed = function () {
        var a = this.Kh(),
            b = this.Yg(),
            c = Mf(this);
        if (a && !a.da(this.A) || this.Y != b || this.la != c) this.j || _.Nf(this.f), this.U(), this.Y = b, this.la = c;
        this.A = a
    };
    _.m.qa = function () {
        var a = Mf(this);
