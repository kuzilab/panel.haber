...
! function (r) {
    ...
    S.extend(S.FE.DEFAULTS, {
                                ...
                                n = function e(t, r) {
                                    ...
                                    for (; o && C(o);) {
                                        var g = o.previousElementSibling,
                                            u = m(o);
                                        if (a < u) s += e(o, r).outerHTML;
                                        else {
                                            if (u < a) break;
                                            s += "</li><li>" + h(o, r)
                                        }
                                        if (a = u, o.previousElementSibling || o.nextElementSibling || o.parentNode) {
                                            var f = o;
                                            o = o.nextElementSibling, y(f), f = null
        ...
        function h(e, t) {
            ...
            g(r, function (e) {
                return e.nodeType == Node.ELEMENT_NODE && ("mso-list:Ignore" == e.getAttribute("style") && e.parentNode.removeChild(e), f(e, t)), !0
            });
            var n = r.innerHTML;
        ...
        function N(e) {
            var t = e.parentNode,
                r = e.getAttribute("align");
            r && (t && "TD" == t.tagName ? t.setAttribute("style", t.getAttribute("style") + "text-align:" + r + ";") : e.style["text-align"] = r, e.removeAttribute("align"))
        }
        ...
        function u(e, t, r) {
            for (var i = e.split(r), n = 1; n < i.length; n++) {
                ...
                if (1 < (l = l.split("shplid")).length) {
                    ...
                    if (2 < u.length && -1 != u[0].indexOf("blipuid")) g = u[1].split(" ");
                    else {
                        if ((g = u[0].split(" ")) && g.length < 2) continue;
                        g.shift()
                    }
                    var f = g.join("");
                    p[t + a] = {
        ...
        function f(e, t) {
            ...
            if (-1 != ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(r)) {
                ...
                if (u && (t && t[r.toLowerCase() + "." + u] && x(e, t[r.toLowerCase() + "." + u]), -1 != u.toLowerCase().indexOf("mso"))) {
                    var f = w(u);
                    (f = f.replace(/[0-9a-z-_]*mso[0-9a-z-_]*/gi, "")) ? e.setAttribute("class", f): e.removeAttribute("class")
                }
            ...
            if ("TR" == r && function (e, t) {
                    ...
                    for (var r = e.firstElementChild, i = 0, n = !1, l = null; r;) {
                        ...
                        for (var a = r.firstElementChild, s = 1 == r.children.length; a;) "P" != a.tagName || C(a) || s && N(a), a = a.nextElementSibling;
                        if (t) {
                            var o = r.getAttribute("class");
                            if (o) {
                                var d = (o = w(o)).match(/xl[0-9]+/gi);
                                if (d) {
                                    var g = "." + d[0];
                                    t[g] && x(r, t[g])
                                }
                        ...
                        u && (u = w(u)) && ";" != u.slice(-1) && (u += ";");
                        var f = r.getAttribute("valign");
                        if (!f && u) {
                            var p = u.match(/vertical-align:.+?[; "]{1,1}/gi);
                            p && (f = p[p.length - 1].replace(/vertical-align:(.+?)[; "]{1,1}/gi, "$1"))
                        }
                        var c = null;
                        if (u) {
                        ...
                        b && r.setAttribute("colspan", b), E && r.setAttribute("rowspan", E), f && (r.style["vertical-align"] = f), c && (r.style["text-align"] = c), h && (r.style["background-color"] = h), l && r.setAttribute("width", l), r = r.nextElementSibling
                    }
