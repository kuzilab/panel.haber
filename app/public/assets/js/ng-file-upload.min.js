/*! 9.0.9 */ !window.XMLHttpRequest || window.FileAPI && FileAPI.shouldLoad || (window.XMLHttpRequest.prototype.setRequestHeader = function (a) {
    return function (b, c) {
        if ("__setXHR_" === b) {
            var d = c(this);
...
ngFileUpload.version = "9.0.9", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
        function d(d) {
            function g(a) {
        ...
        this.rename = function (a, b) {
            ...
            function g(d, e, f) {
                if (void 0 !== e)
                    if (angular.isDate(e) && (e = e.toISOString()), angular.isString(e)) d.append(f, e);
                    else if (b(e)) {
                    var h = c(e, d),
                        i = f.split(",");
        ...
        function e(a, b, c, d) {
            var e = g.attrGetter("ngfResize", b, c);
            if (!e || !g.isResizeSupported()) return d();
            for (var f = a.length, h = function () {
                    f--, 0 === f && d()
                }, i = function (b) {
                    return function (c) {
                        a.splice(b, 1, c), h()
                ...
                var l = a[k];
                0 === l.type.indexOf("image") ? g.resize(l, e.width, e.height, e.quality).then(i(k), j(l)) : h()
            }
        }

        function f(a, b, c, d) {
            var e = [],
                f = g.attrGetter("ngfKeep", c, d);
            if (f) {
                var h = !1;
                if ("distinct" === f || g.attrGetter("ngfKeepDistinct", c, d) === !0) {
                    var i = b.length;
                    if (a)
        ...
        var g = d;
        return g.getAttrWithDefaults = function (a, b) {
            if (null != a[b]) return a[b];
            var c = g.defaults[b];
            return null == c ? c : angular.isString(c) ? c : JSON.stringify(c)
        }, g.attrGetter = function (b, c, d, e) {
        ...
        }, g.shouldUpdateOn = function (a, b, c) {
            var d = g.attrGetter("ngModelOptions", b, c);
            return d && d.updateOn ? d.updateOn.split(" ").indexOf(a) > -1 : !0
        }, g.updateModel = function (c, d, h, i, j, k, l) {
            function m(e, f, j, l, m) {
                var n = e && e.length ? e[0] : null;
                c && (g.applyModelValidation(c, e), c.$ngfModelChange = !0, c.$setViewValue(m ? n : e)), i && a(i)(h, {
                    $files: e,
                    $file: n,
                    $newFiles: j,
                    $duplicateFiles: l,
                ...
                var o = g.attrGetter("ngfModelInvalid", d);
                o && b(function () {
                    a(o).assign(h, f)
                }), b(function () {})
            }
            var n = j,
                o = (c && c.$modelValue || d.$$ngfPrevFiles || []).slice(0),
                p = f(j, o, d, h);
            j = p.files;
            var q = p.dupFiles,
                r = !g.attrGetter("ngfMultiple", d, h) && !g.attrGetter("multiple", d) && !p.keep;
            d.$$ngfPrevFiles = j, g.validate(n, c, d, h, function () {
                if (l) m(j, [], n, q, r);
                else {
                    var a = g.attrGetter("ngModelOptions", d, h);
                    if (!a || !a.allowInvalid) {
                        var c = [],
                            f = [];
                        angular.forEach(j, function (a) {
                            a.$error ? f.push(a) : c.push(a)
                        }), j = c
                    }
                    e(j, d, h, function () {
                        b(function () {
            ...
            for (var s = o.length; s--;) {
                var t = o[s];
                window.URL && t.blobUrl && (URL.revokeObjectURL(t.blobUrl), delete t.blobUrl)
            }
        }, g
    ...
    function () {
        ...
        ngFileUpload.service("UploadDataUrl", ["UploadBase", "$timeout", "$q", function (a, b, c) {
            ...
            }, d.dataUrl = function (a, d) {
                if (d && null != a.$ngfDataUrl || !d && null != a.$ngfBlobUrl) {
                    var e = c.defer();
                    return b(function () {
                        e.resolve(d ? a.$ngfDataUrl : a.$ngfBlobUrl, a)
                    }), e.promise
                }
                ...
                return b(function () {
                    if (window.FileReader && a && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 8") || a.size < 2e4) && (!window.FileAPI || -1 === navigator.userAgent.indexOf("MSIE 9") || a.size < 4e6)) {
                        ...
                        if (c && c.createObjectURL && !d) {
                            ...
                            b(function () {
                                a.$ngfBlobUrl = e, e && g.resolve(e, a)
                            })
                        } else {
        ...
        return f.validatePattern = function (a, b) {
            ...
            function g(c, d, e) {
                if (a) {
                    for (var f = "ngf" + c[0].toUpperCase() + c.substr(1), g = a.length, h = null; g--;) {
                        ...
                        null == k && (k = d(i("ngfValidate") || {}), h = null == h ? !0 : h), null != k && (e(j, k) || (j.$error = c, j.$errorParam = k, a.splice(g, 1), h = !1))
                    }
            ...
            function h(c, d, f, g, h) {
                if (a) {
                    ...
                    a = void 0 === a.length ? [a] : a, angular.forEach(a, function (a) {
                        if (0 !== a.type.search(f)) return !0;
                        var n = i(m, {
                            $file: a
                        }) || d(i("ngfValidate", {
                            $file: a
                        }) || {});
                        n && (j++, k++, g(a, n).then(function (b) {
                            h(b, n) || (a.$error = c, a.$errorParam = n, l = !0)
                        }, function () {
                            i("ngfValidateForce", {
                                $file: a
                            }) && (a.$error = c, a.$errorParam = n, l = !0)
                        })["finally"](function () {
                            j--, k--, k || b.$ngfValidations.push({
                                name: c,
                                valid: !l
                            }), j || e.call(b, b.$ngfValidations)
                        }))
                    })
                }
            }
            ...
            if (null == a || 0 === a.length) return void e.call(b);
            if (a = void 0 === a.length ? [a] : a.slice(0), g("pattern", function (a) {
                    ...
                    return b === !0 || null === b || "" === b
                }), !a.length) return void e.call(b, b.$ngfValidations);
            var j = 0;
            h("maxHeight", function (a) {
                return a.height && a.height.max
            }, /image/, this.imageDimensions, function (a, b) {
                return a.height <= b
            }), h("minHeight", function (a) {
                return a.height && a.height.min
            }, /image/, this.imageDimensions, function (a, b) {
                return a.height >= b
            }), h("maxWidth", function (a) {
                return a.width && a.width.max
            }, /image/, this.imageDimensions, function (a, b) {
                return a.width <= b
            }), h("minWidth", function (a) {
        ...
        return d.dataUrltoBlob = function (a) {
            for (var b = a.split(","), c = b[0].match(/:(.*?);/)[1], d = atob(b[1]), e = d.length, f = new Uint8Array(e); e--;) f[e] = d.charCodeAt(e);
            return new Blob([f], {
                type: c
            })
        }, d.isResizeSupported = function () {
            var a = document.createElement("canvas");
            return window.atob && a.getContext && a.getContext("2d")
        }, d.resize = function (a, e, g, h) {
            var i = b.defer();
            return 0 !== a.type.indexOf("image") ? (c(function () {
                i.resolve("Only images are allowed for resizing!")
            }), i.promise) : (d.dataUrl(a, !0).then(function (b) {
                f(b, e, g, h, a.type).then(function (b) {
                    var c = d.dataUrltoBlob(b);
                    c.name = a.name, i.resolve(c)
                }, function () {
                    i.reject()
                })
            }, function () {
    ...
    function () {
        function a(a, c, d, e, f, g, h, i, j) {
            ...
            function l(a, b, c, d) {
                ...
                else if (e && (e.delay && (s = e.delay), e.accept || e.reject)) {
                    var g = c.dataTransfer.items;
                    if (null != g && g.length)
                        for (var h = e.pattern || o("ngfPattern", a, {
                                $event: c
                            }), j = g.length; j--;) {
            ...
            function m(a, b, c, d) {
                        ...
                        if (b.isDirectory) {
                            ...
                            var h = function () {
                                f.readEntries(function (d) {
                                    try {
                                        if (d.length) g = g.concat(Array.prototype.slice.call(d || [], 0)), h();
                                        else {
                ...
                if (j && j.length > 0 && "file" !== h.protocol())
                    for (var k = 0; k < j.length; k++) {
                        ...
                        if (null != n)
                            for (var o = 0; o < n.length && (f.push(n.item(o)), d || !(f.length > 0)); o++);
                    }
                var p = 0;
                ! function q(a) {
                    g(function () {
                    ...
                    if (f) {
                        ...
                        f.replace(/<img .*src *=\"([^\"]*)\"/, function (a, b) {
                            ...
                            var f = new Uint8Array(c.data),
                                g = c.headers("content-type") || "image/jpg",
                                h = new Blob([f], {
                                    type: g
                                });
