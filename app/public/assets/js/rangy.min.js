    ...
    H.addShimListener = function (a) {
        ...
        H.createCoreModule("DomRange", ["DomUtil"], function (a, b) { /*----------------------------------------------------------------------------------------------------------------*/
            ...
            var ha = ga ?
                ...
                ia = ["startContainer", "startOffset", "endContainer", "endOffset", "collapsed", "commonAncestorContainer"],
                ja = 0,
                ka = 1,
                la = 2,
                ma = 3,
            ...
            K.extend(a.rangePrototype, {
                compareBoundaryPoints: function (a, b) {
                    ...
                    var c, d, e, f, g = a == ma || a == ja ? "start" : "end",
                        h = a == ka || a == ja ? "start" : "end";
                    ...
                    n = function (a, b, c, d, f) {
                        ...
                        if (
                            ...
                            if (/[\r\n]/.test(q.data)) {
                                ...
                                var x = h.duplicate(),
                                    y = x.text.replace(/\r\n/g, "\r").length;
                                for (w = x.moveStart("character", y);
                                    (m = x.compareEndPoints("StartToEnd", x)) == -1;) w++, x.moveStart("character", 1)
        ...
        H.createCoreModule("WrappedSelection", ["DomRange", "WrappedRange"], function (a, b) {
            ...
            function p(b) {
                if (
                    ...
                    b._ranges.length = 0, "None" == b.docSelection.type) j(b);
                else {
            ...
            function x(a) {
                ...
                if ("undefined" != typeof a.rangeCount)
                    for (var f = 0, g = a.rangeCount; f < g; ++f) b[f] = F.inspect(a.getRangeAt(f));
