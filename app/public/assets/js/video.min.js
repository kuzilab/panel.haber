...
! function (i) {
    ...
    G.extend(G.FE.POPUP_TEMPLATES, {
        ...
        function k() {
            ...
            if (o)
                for (e = 0; e < o.length; e++) i.indexOf(o[e].getAttribute("src")) < 0 && v.events.trigger("video.removed", [G(o[e])]);
            o = t
        }
        ...
        return r[1] = "Video cannot be loaded from the passed link.", r[d] = "No link in upload response.", r[l] = "Error during file upload.", r[c] = "Parsing response failed.", r[h] = "File is too large.", r[g] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", v.shared.vid_exit_flag = !1, {
            ...
            showInsertPopup: function () {
                ...
                if (t || (t = n()), C(), !t.hasClass("fr-active"))
            ...
            insertByURL: function (e) {
                ...
                if (/^http/.test(e) || (e = "https://" + e), v.helpers.isURL(e))
                    for (var i = 0; i < G.FE.VIDEO_PROVIDERS.length; i++) {
        ...
        NAME: "video-camera",
        FA5NAME: "camera"
    }), G.FE.DefineIcon("videoByURL", {
        NAME: "link"
    }), G.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.DefineIcon("videoEmbed", {
        NAME: "code"
    }), G.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.DefineIcon("videoUpload", {
        NAME: "upload"
    }), G.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.DefineIcon("videoDisplay", {
        NAME: "star"
    }), G.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
        options: {
            inline: "Inline",
    ...
    }), G.FE.DefineIcon("video-align", {
        NAME: "align-left"
    }), G.FE.DefineIcon("video-align-left", {
        NAME: "align-left"
    }), G.FE.DefineIcon("video-align-right", {
        NAME: "align-right"
    }), G.FE.DefineIcon("video-align-center", {
        NAME: "align-justify"
    }), G.FE.DefineIcon("videoAlign", {
        NAME: "align-center"
    }), G.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {
            left: "Align Left",
        ...
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = G.FE.COMMANDS.videoAlign.options;
    ...
    }), G.FE.DefineIcon("videoReplace", {
        NAME: "exchange"
    }), G.FE.RegisterCommand("videoReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), G.FE.DefineIcon("videoRemove", {
        NAME: "trash"
    }), G.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function () {
            this.video.remove()
        }
    }), G.FE.DefineIcon("videoSize", {
        NAME: "arrows-alt"
    }), G.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }), G.FE.DefineIcon("videoBack", {
        NAME: "arrow-left"
    }), G.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
